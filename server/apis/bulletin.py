...
class BulletinAPI(Resource):
    ...
    def get(self, id=None):
        if not id:
            ...
            if all_post:
                payload = {i: post.as_dict() for i, post in enumerate(all_post)}
        ...
        return make_response(jsonify({'message': 'Post don\'t exists.'}), 202)
    ...
    def post(self):
        ...
        new_post.save()
        return make_response(jsonify({'message': 'Suscessfully add post.'}), 200)
